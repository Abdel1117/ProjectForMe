<section class="Mentions_legales_main_container" id="ML_container">
    <h1 class="title_page"><?= $title ?></h1>
<div class="container_of_mention">
    <div class="info_editor_app">
       
              
    <h2>Définitions</h2>
                <p><b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code civil, ou personne morale, qui visite le Site objet des présentes conditions générales.<br>
                <b>Prestations et Services :</b> <a href="http://space-explorer.fr">http://space-explorer.fr</a> met à disposition des Clients :</p>

                <p><b>Contenu :</b> Ensemble des éléments constituants l’information présente sur le Site, notamment textes – images – vidéos.</p>

                <p><b>Informations clients :</b> Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données personnelles susceptibles d’être détenues par <a href="http://space-explorer.fr">http://space-explorer.fr</a> pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.</p>
                ...
                <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet <a href="http://space-explorer.fr">http://space-explorer.fr</a> l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi:
                </p><p><strong>Propriétaire</strong> :   Adjali Abderahmane   – 8 rue des lilas 93600 Aulnay-sous-Bois<br>
                              
                <strong>Responsable publication</strong> : Adjali – abderahmane.adjali@live.fr<br>
                Le responsable publication est une personne physique ou une personne morale.<br>
                <strong>Webmaster</strong> : Adjali Abderahmane – abderahmane.adjali@live.fr<br>
                <strong>Hébergeur</strong> : O2switch – 222 Bd Gustave Flaubert 63000 Clermont-Ferrand 04 44 44 60 40<br>
                ...
                <p>Le site internet <a href="http://space-explorer.fr">http://space-explorer.fr</a> a pour objet de fournir une information concernant l’ensemble des activités de la société.
                ...
                Le site <a href="http://space-explorer.fr">http://space-explorer.fr</a> est hébergé chez un prestataire sur le territoire de l’Union Européenne conformément aux dispositions du Règlement Général sur la Protection des Données (RGPD : n° 2016-679)</p>

                <p>L’objectif est d’apporter une prestation qui assure le meilleur taux d’accessibilité. L’hébergeur assure la continuité de son service 24 Heures sur 24, tous les jours de l’année. Il se réserve néanmoins la possibilité d’interrompre le service d’hébergement pour les durées les plus courtes possibles notamment à des fins de maintenance, d’amélioration de ses infrastructures, de défaillance de ses infrastructures ou si les Prestations et Services génèrent un trafic réputé anormal.</p>

                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> et l’hébergeur ne pourront être tenus responsables en cas de dysfonctionnement du réseau Internet, des lignes téléphoniques ou du matériel informatique et de téléphonie lié notamment à l’encombrement du réseau empêchant l’accès au serveur.</p>

                <h2>5. Propriété intellectuelle et contrefaçons.</h2>

                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous les éléments accessibles sur le site internet, notamment les textes, images, graphismes, logos, vidéos, icônes et sons.
                Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : <a href="http://space-explorer.fr">http://space-explorer.fr</a>.</p>

                <p>Toute exploitation non autorisée du site ou de l’un quelconque des éléments qu’il contient sera considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>

                <h2>6. Limitations de responsabilité.</h2>

                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> agit en tant qu’éditeur du site. <a href="http://space-explorer.fr">http://space-explorer.fr</a>  est responsable de la qualité et de la véracité du Contenu qu’il publie. </p>
                ...
                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> ne pourra également être tenu responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://space-explorer.fr">http://space-explorer.fr</a>.
                ...
                <p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa navigation sur le Site, le responsable du traitement des Données Personnelles est : Adjali Abderahmane. <a href="http://space-explorer.fr">http://space-explorer.fr</a>est représenté par Adjali, son représentant légal</p>
                ...
                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> est susceptible de traiter tout ou partie des données : </p>
                ...
                <li>pour mener des enquêtes de satisfaction facultatives sur <a href="http://space-explorer.fr">http://space-explorer.fr</a> : adresse email </li>
                <li>pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>


                </ul>

                <p><a href="http://space-explorer.fr">http://space-explorer.fr</a> ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par nécessité ou à des fins statistiques et d’analyses.</p>
                 
                <h3>7.3 Droit d’accès, de rectification et d’opposition</h3>
                 
                <p>
                Conformément à la réglementation européenne en vigueur, les Utilisateurs de <a href="http://space-explorer.fr">http://space-explorer.fr</a> disposent des droits suivants : </p>
                 <ul>
                ...
                <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a href="http://space-explorer.fr">http://space-explorer.fr</a> devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné</li>
                 </ul>
                ...
                Adjali Abderahmane – DPO, Adjali Abderahmane <br>
                8 rue des lilas 93600 Aulnay-sous-Bois.
                 
                <p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <a href="http://space-explorer.fr">http://space-explorer.fr</a> corrige, mette à jour ou supprime, en s’identifiant précisément avec une copie d’une pièce d’identité (carte d’identité ou passeport). </p>
                ...
                <p>
                Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a href="http://space-explorer.fr">http://space-explorer.fr</a> et des sous-traitants (prestataires de services), exclusivement afin de réaliser les finalités de la présente politique.</p>
                <p>
                Dans la limite de leurs attributions respectives et pour les finalités rappelées ci-dessus, les principales personnes susceptibles d’avoir accès aux données des Utilisateurs de <a href="http://space-explorer.fr">http://space-explorer.fr</a> sont principalement les agents de notre service client.</p>
                ...
                <p>
                Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données Personnelles de Santé, <a href="http://space-explorer.fr">http://space-explorer.fr</a> utilise des réseaux protégés par des dispositifs standards tels que par pare-feu, la pseudonymisation, l’encryption et mot de passe. </p>
                 
                <p>
                Lors du traitement des Données Personnelles, <a href="http://space-explorer.fr">http://space-explorer.fr</a>prend toutes les mesures raisonnables visant à les protéger contre toute perte, utilisation détournée, accès non autorisé, divulgation, altération ou destruction.</p>
                ...
                Le prestataire externe pourra éventuellement recueillir des informations sur les visiteurs du Site et d’autres sites Internet grâce à ces balises, constituer des rapports sur l’activité du Site à l’attention de <a href="http://space-explorer.fr">http://space-explorer.fr</a>, et fournir d’autres services relatifs à l’utilisation de celui-ci et d’Internet.</p>
                 ...
                 <p>
                Tout litige en relation avec l’utilisation du site <a href="http://space-explorer.fr">http://space-explorer.fr</a> est soumis au droit français. 
